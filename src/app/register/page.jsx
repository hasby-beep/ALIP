    ...
    <div className="min-h-screen bg-[#154d08] flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-black w-full max-w-lg rounded-3xl shadow-[0_20px_30px_rgba(0,0,0,0.25)] p-8">
        ...
        <input
          ...
          className="w-full border border-gray-500 rounded-2xl px-5 py-4 mb-8 outline-none bg-transparent text-lg"
        />

        {/* Button */}
        <div className="flex justify-center">
          <button className="bg-[#154d08] text-white text-3xl font-bold px-20 py-3 rounded-2xl hover:scale-105 transition duration-300">
            Register
          </button>
        </div>
